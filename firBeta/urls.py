...
urlpatterns = [
    ...
    path('ps/filter/', views.filter_fir_ps_view, name='filter_fir_ps'),
    path('ps/filter/<int:asc>/', views.filter_fir_ps_view, name='filter_fir_ps_asc'),
    ...
    path('vrk/filter/', views.filter_fir_vrk_view, name='filter_fir_vrk'),
    path('vrk/filter/<int:asc>/', views.filter_fir_vrk_view, name='filter_fir_vrk_asc'),
    ...
    path('nc/filter/', views.filter_fir_nc_view, name='filter_fir_nc'),
    path('nc/filter/<int:asc>/', views.filter_fir_nc_view, name='filter_fir_nc_asc'),
